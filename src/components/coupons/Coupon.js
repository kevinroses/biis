...
import { DateTime, Duration } from "luxon"; // Cambio a Luxon
...
const Coupon = (props) => {
  ...
  // Cambios en el formato de las fechas usando Luxon
  const startDate = DateTime.fromISO(coupon?.start_date);
  const endDate = DateTime.fromISO(coupon?.end_date);
  ...
  return (
    ...
    >
      <Stack alignItems="center" direction="row">
        ...
        <CouponStyle>
          {/* Reemplazar con el componente adecuado de Luxon */}
          {/* <CouponVector /> */}
        </CouponStyle>
        <Stack
          spacing={0.5}
        ...
        >
          ...
          <Typography fontSize={{ xs: "10px", md: "12px" }} fontWeight="500">
            {startDate.toFormat("dd MMM, yyyy")} {t("to")}{" "}
